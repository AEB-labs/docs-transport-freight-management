...
The multi-carrier platform _Carrier Connect_ lets you send single- and multi-package shipments around the  
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/4533de9-CCO-Prozess_en.png",
        null,
        ""
      ],
      "align": "center"
...
data manually right in the _Carrier Connect_ user interface. The shipping order data includes all the  
...
_Carrier Connect_ provides the correct shipping label and any other shipping documents, then feeds them  
...
numbers in order to track the package and shipment. The _Carrier Event Service_ option gives you access  
