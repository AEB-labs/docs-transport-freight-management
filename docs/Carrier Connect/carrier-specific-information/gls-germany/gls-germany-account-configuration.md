...
| 4      | Single pkg. handling | See [Single Package Handling](https://transport-freight-management.docs.developers.aeb.com/docs/gls-germany-account-configuration#single-package-handling)                                                                                                                                         |
| 5      | Customer no.         | Assigned by the carrier                                                                                                                                                                                                                                                                            |
| 6      | EDI transmission     | Set to _Send and log_                                                                                                                                                                                                                                                                              |
| 7      | Contact ID           | Assigned by the carrier                                                                                                                                                                                                                                                                            |
| 8      | Alt. server URL      | Assigned by the carrier. The URL used for the GLS webservice. It looks like this: [https://shipit-wbm-de01.gls-group.eu:8443/backend/ShipmentProcessingService/ShipmentProcessingPortType](https://shipit-wbm-de01.gls-group.eu:8443/backend/ShipmentProcessingService/ShipmentProcessingPortType) |
