...
* `type`: Name of the reference field. All valid types are listed in the <a href="https://transport-freight-management.docs.developers.aeb.com/reference/createshipment" target="_blank">API Reference</a> (createShipment > shipment > referencesTexts > type) of Carrier Connect.
