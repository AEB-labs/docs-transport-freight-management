...
With the <a href="https://transport-freight-management.docs.developers.aeb.com/reference/cancelshipment" target="_blank">cancelShipment</a> call you can cancel a <Glossary>shipping order</Glossary>. 
...
> ❗️ It's important to highlight, that the `cancelShipment` call sets the shipping order status to *canceled*; the order itself will not be deleted.
>
