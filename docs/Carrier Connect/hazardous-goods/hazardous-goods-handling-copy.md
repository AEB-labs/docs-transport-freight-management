---
title: 'New & better: 🧪 Hazardous goods handling'
excerpt: ''
deprecated: false
hidden: true
metadata:
...
Hazardous goods handling has to be enabled in the carrier configuration for each carrier separately. 

[https://rz3.aeb.de/docudata/OnlineHelp/cai/en-US/index.html#673167627673169163](https://rz3.aeb.de/docudata/OnlineHelp/cai/en-US/index.html#673167627673169163)
