...
The relevant request is called <a href="https://transport-freight-management.docs.developers.aeb.com/reference/getcarrierproperties" target="_blank">getCarrierProperties</a>.
