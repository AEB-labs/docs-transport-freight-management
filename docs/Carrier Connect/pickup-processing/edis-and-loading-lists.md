...
With the <a href="https://carrierconnect.docs.developers.aeb.com/reference#processpickup-1" target="_blank">processPickup</a> call, it is possible to complete a partially processed collection including document printing and EDI dispatch in Carrier Connect. The corresponding parameters must be entered in the processParms.
