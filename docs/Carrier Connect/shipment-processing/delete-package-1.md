...
Use <a href="https://carrierconnect.docs.developers.aeb.com/reference#deletepackage-1" target="_blank">deletePackage</a> with e.g. the *shipment number* of the shipment and the *referenceNumber1* as reference to the package to delete the package from a shipment.
