...
To use the CarrierSelect-API from S/4Hana or SAP ERP 6.0 you need to generate one or more Enterprise Services. You have to generate an Enterprise Services for each WSDL you like to use. 
...
The url you have to set is [https://rz3.aeb.de/test2routing/servlet/bf/RoutingBF?WSDL](https://rz3.aeb.de/test2routing/servlet/bf/RoutingBF?WSDL).\
...
![](https://files.readme.io/6f65189-2019-05-16_165610.png "2019-05-16_165610.png")
...
![](https://files.readme.io/220d760-2019-05-16_173113.png "2019-05-16_173113.png")
