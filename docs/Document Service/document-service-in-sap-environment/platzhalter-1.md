...
Path prefix: /_test1docs_/rest/DocumentService/document (this may be different depending on which instance your client runs)
...
If you want to use the application facade of the Document Service (e.g. for the type write mode) you will have to set up a second connection with a different path prefix /_test1docs_/rest/DocumentService/ui/document  (this may be different depending on which instance your client runs).