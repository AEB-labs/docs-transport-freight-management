...
- Go to the [API Reference](https://transport-freight-management.docs.developers.aeb.com/reference/acknowledgechangedsettlements) of this documentation and navigate to the _Logistics Cost Management_ section.
