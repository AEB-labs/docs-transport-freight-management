...
This configuration will enable you to access all methods from [https://rz3.aeb.de/test2billing/swagger/#/Billing](https://rz3.aeb.de/test2billing/swagger/#/Billing).

For the connection to work you need to import the SSL certificates from AEB like described in this documentation: [https://rz3.aeb.de/docudata/inst-config-guides/carrier-connect/installconfig-carrierconnect-plug-insap/en-US/index.html#384034443665524875](https://rz3.aeb.de/docudata/inst-config-guides/carrier-connect/installconfig-carrierconnect-plug-insap/en-US/index.html#384034443665524875).
