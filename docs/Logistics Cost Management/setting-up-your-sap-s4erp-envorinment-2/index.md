...
You can stay on the tab Service Administration. Go to Web Service Configuration and search for our proxy class ZCO\_IBILLING\_BF.  Just put the string ZCO\_IBILLING\_BF to the filter field object name and click on search. 
